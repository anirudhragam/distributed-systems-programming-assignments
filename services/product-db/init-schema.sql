...
VALUES 
  ...
  (2, 'Personal Computer', 1, ARRAY['computer', 'pc', 'desktop'], 'New', 499.99, 30, 0, 0),
  (3, 'Gaming Computer', 1, ARRAY['gaming', 'pc', 'high-end'], 'New', 1499.99, 20, 0, 0),
  (3, 'HDMI Cable', 4, ARRAY['cable', 'hdmi'], 'New', 9.99, 300, 0, 0),
